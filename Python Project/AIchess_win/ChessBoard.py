...
class ChessBoard(object):
    ...
    def judge_attack_general(self, attack_player):
        ...
        if (general_position is None): return True
    ...
    def judge_win(self, attack_player):
        ...
        r_general_position = self.get_general_position("r")
        b_general_position = self.get_general_position("b")
        if (r_general_position is None or b_general_position is None): return True;
